...
public class Window extends JFrame implements ActionListener {
	...
	int ques_num = 1, sign = 0, right = 0, error = 0, ques_amount = 5;
	int answer0 = 0;
	...
	public Window() {
		...
		lable2.setFont(new Font("宋体", Font.PLAIN, 30));
		lable2.setSize(134, 63);
		lable2.setLocation(431, 86);
		frm.getContentPane().add(lable2);
